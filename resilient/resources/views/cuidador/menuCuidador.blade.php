                ...
                <div  class="card-body">
                    ...
                    <div class="row">   
                             <div class="col-md-6">
                               ...
                               <a href=""> 
                                <div class="card-body small-padding text-center">
                                    <img style="width:100%;height:300px" src="{{ asset('img/logros.jpg') }}" alt=""> Ir A Mis Logros
                               </div></a>
                                 </div>
                            </div>  
                             ...
                             <a href=""> 
                             <div class="card-body small-padding text-center">
                                  <img style="width:100%;height:300px" src="{{ asset('img/ranking.jpg') }}" alt=""> Ir Al Ranking
                             </div> 
                           </a>
                                </div>
                        </div>
