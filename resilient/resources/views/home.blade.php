                ...
                <div  class="card-body">
                    <div class="col-md-3 col-xs-6">
                        <div class="card card1">
                            <a href=""><div class="card-body small-padding style-primary-dark text-center">Perfil</div></a>
                        </div>
                        <br><br>
                        <div class="card card2">
                            <a href=""><div class="card-body small-padding style-primary text-center">Usuarios</div></a>
                        </div>
                        <br><br>
