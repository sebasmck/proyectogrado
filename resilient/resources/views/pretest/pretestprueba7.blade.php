        ...
        <form class="form">
            <div class="card">
                ...
                <div class="card-head style-primary">
                    <header>Pretest prueba 7</header>
                </div>
            ...
            <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/pretestprueba8')}}"> <button type="button" class="btn btn-default ink-reaction btn-primary-dark">Siguiente</button></a>
                    </div>
              </div>
