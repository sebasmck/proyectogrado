		<!-- BEGIN HEADER-->
		<header id="header">
			<div class="headerbar" style="margin-bottom: 10000px;">
				<!-- Brand and toggle get grouped for better mobile display -->
				<div class="headerbar-left">
					<ul class="header-nav header-nav-options">
						<li class="header-nav-brand" >
							<div class="brand-holder">
								<img src="{{asset('img/logo.png')}}" style="margin-right: 25px;" alt="">
									<span class="text-lg text-bold text-primary"><strong>RESILIENT</strong></span>
								</a>
							</div>
						</li>
					</ul>
