                ...
                <div  class="card-body">
                    <div class="col-md-3 col-xs-6">
                        ...
                        <div class="card card2">
                            <a href="{{route('/users')}}"><div class="card-body small-padding style-primary text-center">Respuestas usuarios Pretest</div></a>
                        </div>
                        <br><br>
                        <div class="card card3">
                           <a href=""> <div class="card-body small-padding style-primary-light text-center">Respuestas usuarios Postest</div></a>
                        </div>
                        <br><br>
                        <div class="card card4">
                           <a href=""> <div class="card-body small-padding style-primary-bright text-center">Respuestas usuarios Escala Parentabilidad positiva</div> </a>
                        </div>
                        <br><br>
                        <div class="card card5">
                           <a href=""> <div class="card-body small-padding style-primary-bright text-center">Respuestas usuarios Escala Walding y Young</div> </a>
                        </div>
...
<script>
    ...
    tl.from(card5, .3, {left:100, opacity:0});
