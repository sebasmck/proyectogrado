                  ...
                  <!--  <video autobuffer autoloop loop controls>
                    ...
                    <div class="col-md-8 col-xs-6">
                        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10.0.0.0" width="550" height="400">
                            <param name="movie" value="character_creator.swf" />
                            <param name="quality" value="high" />
                            <embed src="http://localhost/character_creator.swf" quality="high" type="application/x-shockwave-flash" width="550" height="400" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>
                        </object>
                    </div>
                     <div class="col-md-2 col-xs-6"></div>
                    </div>
