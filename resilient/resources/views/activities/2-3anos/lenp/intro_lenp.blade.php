    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad las emociones de nuestros padres/cuidadores
            </div>
        </div> 
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Promoción de la Resiliencia</td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="card">
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <p style="text-align:justify; text-justify: inter-word; color:black;">
                                ...
                                Las emociones son una parte importante de la vida, se relacionan con cada 
                                una de las situaciones que se experimentan en la vida cotidiana y ayudan 
                                a saber cómo reaccionar ante cada situación. Desde su parte biológica 
                                permiten sobrevivir a las diferentes necesidades de cada contexto o ambiente,
                                ¿te imaginas a una persona que camina tranquilamente a media noche por una 
                                calle oscura y que no sienta miedo de que alguien aparezca? Esa es la función 
                                principal de las emociones, generan una alarma para sobrevivir a los ambientes
                                a los que se expone el ser humano todos los días.
                                Como seres humanos se tiene la capacidad de controlar las diferentes emociones,
                                pero en algunos casos solamente avanzan libremente, sin darle ningún control y
                                esto no es beneficioso en algunas situaciones. En el desarrollo de la resiliencia
                                las emociones y su control son un aspecto fundamental, pues al fortalecer la capacidad
                                de manejo de la ira - enojo y de las emociones en general se fortalece la capacidad resiliente.
                                Es por eso que esta semana se te invita a conocer un poco más sobre las emociones,
                                en algunos casos ni siquiera los adultos logran reconocer sus emociones y cuando
                                los niños piden explicación no se sabe una respuesta coherente. 
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/lenp1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
