        ...
        <div class="card">
                ...
                <div>
                    <ul>
                        <li><input type="checkbox" id="cb1" />
                            <label class="grow" for="cb1"><img src="{{asset('ActividadLenp/lenp1.png')}}" /></label>
                        </li>
                        <li><input type="checkbox" id="cb2" />
                            <label class="grow" for="cb2"><img src="{{asset('ActividadLenp/lenp2.png')}}" /></label>
                        </li>
                        <li><input type="checkbox" id="cb3" />
                            <label class="grow" for="cb3"><img src="{{asset('ActividadLenp/lenp3.png')}}" /></label>
                        </li>
                        <li><input type="checkbox" id="cb4" />
                            <label class="grow" for="cb4"><img src="{{asset('ActividadLenp/lenp4.png')}}" /></label>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/lenp_logrosObtenidos')}}"> <button type="button"
