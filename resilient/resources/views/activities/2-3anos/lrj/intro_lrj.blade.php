...
@section('title')
Intro Actividad Las reglas de juego
@endsection
          ...
          <table class="container">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Aporte educativo, aporte socializador, promoción de la resiliencia.</td>
              </tr>
              <tr>
                ...
                <div class="card-body">
                  <label>
                    <p style="text-align:justify; text-justify: inter-word; color:black;">
                      Esta actividad fue diseñada con el propósito de enseñarles a los cuidadores a dirigir los juegos
                      con sus hijos de tal manera que fortalezcan la confianza en sí mismos y en las demás personas
                      como son los compañeros de juego. A través de los juegos aquí planteados los niños aprenden a
                      compartir, a esperar el turno, a tener control sobre si mismos para esperar y se les entrena para
      ...
      <div class="card">
        ...
        <div class="card-actionbar">
          <div class="card-actionbar-row">
            <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/lrj1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
          </div>
        </div>
        <!--end .card-actionbar -->
      </div>
