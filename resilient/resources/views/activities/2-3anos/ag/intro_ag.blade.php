...
@section('title')
Intro Actividad Arbol genialogico
@endsection
                ...
                <div class="card-body">
                  <label>
                    <p style="text-align:justify; text-justify: inter-word; color:black;">
                      Al hablar de prácticas de crianza, es necesario hacer alusión a los padres o a los cuidadores
                      primarios o secundarios, quienes son las personas que cuidan y protegen a los hijos, niños o
                      niñas a su cargo, pues estos infantes son vulnerables a diferentes situaciones de salud,
                      psicosociales y en definitiva del desarrollo del ser humano. Sin embargo, también es muy
                      importante tener en cuenta que la familia no solo son los integrantes de un hogar, sino que por
                      otro lado, está incluida la familia extensa, es decir, abuelos, tíos, primos etc. y ellos también
                      forman parte fundamental del desarrollo del niño. Las prácticas de crianza pueden ser
                      transmitidas de generación en generación, pueden estas ser tomadas en cuenta y repetir la crianza
                      otorgada hacia los hijos o tomar otro camino, otra manera de criar.
                      Resulta entonces, necesario tener en cuenta a las personas de alrededor del niño en su crianza y
                      potenciar las verbalizaciones dirigidas a “Yo tengo” ¿qué personas hacen parte de su crianza?
                      ¿Quiénes son modelo a seguir? ¿Quiénes están enseñándole? Y con ello identificar las
                      posibilidades de acercamiento a personas de confianza cuando se presentan eventualidades adversas
                      o difíciles en el contexto del niño. Grothberg (1995)
      ...
      <div class="card">
        ...
        <div class="card-actionbar">
          <div class="card-actionbar-row">
            <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/ag1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
          </div>
        </div>
        <!--end .card-actionbar -->
      </div>
