                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                Que tu realices actividades como compartir tiempo con tu hijo/a es muy importante, pues
                                  se ha encontrado que los humanos desde bebés aprendemos al ver los comportamientos de
                                   nuestros padres o de personas significativas. Por eso, si tu hijo/a crece viendo que
                                    tu compartes tiempo con él o ella, y que le cuentas cosas de tu diario, creerá que 
                                    está bien y por ende va imitar ese comportamiento. En un futuro, esto hará que sea él 
                                    o ella quien busque compartir tiempo contigo y te cuente cosas de su día.
                                </p>
                             </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/SiempreContigo1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
