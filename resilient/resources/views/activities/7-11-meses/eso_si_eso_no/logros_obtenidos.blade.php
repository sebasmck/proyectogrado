...
<div class="col-lg-offset-2 col-md-8">
        <form class="form" method="get" action="{{route('/eso-si-eso-no-5')}}">
        {{csrf_field()}}
            <div class="card">

                <div class="card-head style-accent-dark">
                   <header> Logros Obtenidos - Hasta el final </header>
                </div>
            ...
            <div class="card-actionbar">
                  ...
                  <a style="btn btn-flat btn-primary ink-reaction"> <button type="submit" class="btn btn-default ink-reaction btn-accent-light">Siguiente</button></a>
                  </div>
            </div>
