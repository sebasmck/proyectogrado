                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Se ha identificado que miradas tranquilas, palabras de advertencia, expresiones de preocupación, placer o de consternación,
                                 en muchas ocasiones le indican al bebé la forma adecuada de reaccionar ante diferentes estímulos que se le presenten,
                                 logrando transformar a padres o cuidadores en una guía social constante. En esta actividad le enseñaras a tu bebé por medio de miradas,
                                 palabras, expresiones faciales el modo de reaccionar ante un suceso desconocido o ambiguo. <br />

                                 <b>¡Vas a lograr ser la mejor referencia social de tu hijo!</b>
                               </p>
                             </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/eso-si-eso-no-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
