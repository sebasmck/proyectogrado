...
<div class="col-lg-offset-2 col-md-8">
        <form class="form"  id="formulario" method="GET" action="{{route('/siempre-juntos-5')}}">
        <div class="card">

                <div class="card-head style-primary">
                   <header>  Siempre juntos  - Cuentos </header>
                </div>
                ...
                <div  style="font-family: 'Raleway', sans-serif; font-size: 14px;color:black;">
                     <p style="text-align:justify; text-justify: inter-word;">
                        A continuación, encontrarás un link con gran cantidad de cuentos que puedes descargar.Haz click <a style="color:blue" href="http://www.cuentosinfantilesadormir.com/descargarcuentosinfantiles.htm" target="_blank" >AQUÍ
                                </a>  , También te enseñaremos unos cuentos en audio que le puedes colocar a tu bebé y que tal vez le gusten mucho. En este link <a style="color:blue" href="https://www.youtube.com/watch?v=AB0u-Vqk-Ao&list=PLR8rxujaIjeCb9JUMfDWKAGWE5e8hH2e2" target="_blank" >AQUÍ
                         </a> encontrarás 63 cuentos, algunos de los que se encuentran son los siguientes:
                     </p>

                    <ul>
                        <li>Cucú cantaba la rana (Cuento).</li>
                        <li>El caracolito (Cuento).</li>
                        <li>El ratón chiquitín (Cuento).</li>
                        <li>El pato Renato (Cuento).</li>
                        <li>El pato Renato (Canción).</li>
                    </ul>
                </div>
