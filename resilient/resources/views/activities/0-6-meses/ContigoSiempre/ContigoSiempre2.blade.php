                  ...
                  <table>
                        ...
                        <tr>
                                <td> 
                                        ...
                                        <label class="grow" for="cb1"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>

                                <td> 
                                        <input type="radio" id="cb2" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb2"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb3" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb3"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb4" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb4"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb5" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb5"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>  
                                <td> 
                                        <input type="radio" id="cb6" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb6"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb7" name="optionsRadios" value="1"/>
                                        <label class="grow" for="cb7"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion1.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                        </tr>  
                        ...
                        <tr>
                                <td> 
                                        ...
                                        <label class="grow" for="cb8"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb9" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb9"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb10" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb10"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb11" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb11"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb12" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb12"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb13" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb13"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>
                                <td> 
                                        <input type="radio" id="cb14" name="optionsRadios1" value="1"/>
                                        <label class="grow" for="cb14"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion2.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>       
                        </tr>  
                        ...
                        <tr>
                                <td> 
                                        ...
                                        <label class="grow" for="cb15"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb16" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb16"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb17" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb17"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb18" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb18"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb19" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb19"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb20" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb20"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>    
                                <td> 
                                        <input type="radio" id="cb21" name="optionsRadios2" value="1"/>
                                        <label class="grow" for="cb21"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion3.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>         
                        ...
                        <tr>
                                <td> 
                                        ...
                                        <label class="grow" for="cb22"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
                                        <input type="radio" id="cb23" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb23"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
                                        <input type="radio" id="cb24" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb24"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
                                        <input type="radio" id="cb25" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb25"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
                                        <input type="radio" id="cb26" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb26"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td>         
                                <td> 
                                        <input type="radio" id="cb27" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb27"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
                                        <input type="radio" id="cb28" name="optionsRadios3" value="1"/>
                                        <label class="grow" for="cb28"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion4.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                        </tr>  
                        <tr>
                                <td> 
                                        ...
                                        <label class="grow" for="cb29"><img WIDTH="100" HEIGTH="100"  id="imagen1" src="{{asset('ActividadSiempreJuntos/cancion5.png')}}" style="margin-inline-start:10%"/> 
                                        </label>
                                </td> 
                                <td> 
