...
@section('title')
Intro Actividad A La Hora De Amamantar
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad a la hora de amamantar
            </div>
        </div> 
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> Creencias acerca de la crianza </td>
                                    </tr>
                                    <tr>
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                  La siguiente estrategia está diseñada para mamás y papás. En la medida en que por diferentes circunstancias el bebé no comparta
                                   con alguno de los dos, no te preocupes, esta guía también es de apoyo para cuidadores primarios y para toda la familia 
                                   en general. Debemos recordar que somos 100% fuentes de amor y felicidad para los bebés que tenemos en casa y que siempre
                                    podemos encontrar la oportunidad de fortalecer nuestro vínculo afectivo con ellos, para de esta manera tener pequeños 
                                    preparados para el futuro, en especial para sus futuras relaciones interpersonales, y que cuenten con características
                                     resilientes. Para cumplir con dicho objetivo, podrás transformar de forma sencilla y divertida dos actividades que 
                                     hacen parte de tu rutina y la del bebé en un momento de encuentro y de vinculación afectiva. Ven a descubrir cómo 
                                     la hora de la alimentación y el contacto táctil se van a convertir en tus mejores aliados a la hora de demostrarle amor
                                      a tu pequeño.
                                </p>
                             </label>
                            </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/HoraAmamantar1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
