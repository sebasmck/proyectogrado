...
@section('title')
Intro Actividad Juguemos A Conocer Nuestras Emociones
@endsection
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Aporte afectivo, cuidado y estimulación / Aporte protector</td>
                                    </tr>
                                    <tr>
                                        <td>Rasgos resilientes</td>
                                        <td> Confianza / Vínculo afectivo</td>
                                    </tr>
                                    <tr>
                                        <td>Semana</td>
                                        <td>6</td>
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                  Una de las formas en que aprendemos a expresar las emociones, es viendo como nuestros padres expresan 
                                  las suyas. En ocasiones puede suceder que ellos u otras personas digan cosas como “deja de enojarte” 
                                  “lloras por todo” “los varones no lloran”, entre otras cosas que lo único que hacen es dificultar el
                                   reconocimiento e identificación de las emociones, y así poderlas expresar mejor. Por esa razón, es 
                                   importante que como cuidador le ayudes a tu hijo(a) a aprender a identificar y reconocer sus emociones;
                                    la siguiente actividad te permitirá enseñarle esto. 
                                  </p>
                                  <p style="text-align:justify; text-justify: inter-word; color:black;">
                                    <b>Metodología</b>
                                    <br><br>
                                    Actividad 2
                                    <ul>
                                    <li>  Caras con las 4 emociones básicas, alegría, enojo, miedo y tristeza</li>
                                    <li>	Palos pequeños de paleta</li>
                                    </ul>
                                    Actividad 3
                                    <ul>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/JuguemosEmociones')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
