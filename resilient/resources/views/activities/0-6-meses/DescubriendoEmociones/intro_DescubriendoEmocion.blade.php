...
@section('title')
Intro Actividad Descubriendo Las Emociones
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad descubriendo las emociones
            </div>
        </div> 
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                Los últimos estudios que se han llevado a cabo nos enseñan que es bueno tener conocimiento sobre las emociones,
                                 ya que esto nos ayuda a saberlas manejar, nos permite entenderlas mejor y nos enseña que aceptar las emociones
                                  tiene más beneficios que intentar ocultarlas o evitarlas. Es por esta razón que en esta semana aprenderás sobre
                                   ellas, que no solo te ayudará a ti, sino que también te permitirá enseñarle a tu hijo(a) esto a medida que crece.
                                </p>
                             </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/DescubriendoEmociones1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
