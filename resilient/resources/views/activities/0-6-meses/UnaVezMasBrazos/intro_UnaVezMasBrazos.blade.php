...
@section('title')
Intro Actividad Una Vez Más En Mis Brazos 
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad una vez más en mis brazos 
            </div>
        </div> 
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                  Cuando alzas a tu bebé, ya sea para amamantarlo, consentirlo o calmar su llanto, sin notarlo estás fortaleciendo la confianza, y una mayor cercanía con él; es por esto que en la siguiente actividad aprenderás diferentes formas de alzar a tu bebé. Es importante que mientras tengas alzado a tu hijo le hables, le des besos, lo mires a los ojos o lo balancees suavemente de un lado a otro, este tipo de actividades también te permitirán fomentar cercanía entre tú y tu bebé.
                                </p>
                                  <p style="text-align:justify; text-justify: inter-word; color:black;">
                                  A medida que realices las posiciones te iremos informando de los 0 a 6 meses entre qué edad puedes practicar la posición con tu hijo, ya que por su proceso de desarrollo, no todas las posiciones son adecuadas. A pesar de que tu hijo no cumpla la edad, puedes aprender la posición para alzarlo cuando tenga la edad adecuada. 
                                  </p>
                                  <p style="text-align:justify; text-justify: inter-word; color:black;">
                                  Las posiciones que aprenderás las deberás practicar entre dos a tres veces por día, en diferentes momentos. También puedes enseñarle estas posiciones a un familiar y/o persona cercana al bebé para que pueda participar de la actividad y fomentar ese lazo. Por ejemplo si vives con el papá de tu bebé le puedes enseñar algunas posiciones y practicar juntos.
                                </p>
                             </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/UnaVezBrazos1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
