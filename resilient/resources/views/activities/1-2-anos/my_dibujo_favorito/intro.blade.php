...
@section('title')
Intro Actividad Mi dibujo favorito
@endsection
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label>
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 El objetivo de esta actividad es propiciar situaciones de elección en el  niño y las respuestas del adulto frente a su elección,
                                 donde los padres sean los que dirijan la actividad dando diferentes opciones al niño,
                                 sin embargo una vez que se consiga un nivel de independencia del infante es necesario dejar que culmine la actividad por sí solo,
                                 pues así estará participando de manera activa en la formación de su propia autonomía.
                               </p>
                            </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/mi-dibujo-favorito-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
