...
@section('title')
Intro Actividad UN TESORO ESCONDIDO. "SOY CAPAZ DE… Y ME AMO COMO SOY”
@endsection
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                Según Munist, Santos, Kotliarenco, Suarez, Infante y Grotberg (1998) la promoción de la capacidad resiliente 
                                nace en los niños y niñas si se promueven atributos como la identificación y control emocional, la empatía,
                                 el sentido del humor ante los errores o dificultades presentadas en sus actividades de la infancia y la descripción 
                                 positiva de sí mismos conocida como la autoestima. Debido a que la autoestima se asocia a un blindaje ante las críticas
                                  sociales, los prejuicios, y todo acto con intensión maldadosa a las que usualmente se ve expuesto el ser humano; 
                                  se considera que amarse a sí mismo, conocerse, valorarse y aceptarse de manera integral,
                                 es un factor protector ante las adversidades, así como parte necesaria de la capacidad resiliente.
                                </p></label>
                            </div>
                        </div>
                    </div>
