                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Reconocimiento De Cuidadores</td>
                                    </tr>
                                    <tr>
                                        <td>Semana</td>
                                        <td>4</td>
                    ...
                    <div class="card">
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                              ...
                              Un paso importante para los niños es el de empezar a asistir a centros de educación. Esta clase de acontecimientos empieza a generar en ellos los primeros signos de independencia y autonomía.  El mundo que conocían se empieza a expandir conviviendo en otros lugares y generando interacciones con niños de sus edades.
                              Es muy importante la respuesta que tienen los padres hacia los niños, cuando ingresan a los centros de educación, ya que esta es una de las situaciones que excluye a la familia y se convierte en una experiencia individual, sin la presencia de los padres.  Sin embargo, aunque sea una experiencia propia de los niños, es necesario ratificar el acompañamiento que se les brinda en esta edad.
                              Por lo anterior, la confianza básica es una habilidad que se debe fomentar en los niños en este paso tan grande, pues, aunque estén solos es necesario que se sientan respaldados por sus cuidadores.
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/CreandoConfianza1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>  
