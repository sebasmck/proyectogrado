    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad las gafas de las emociones
            </div>
        </div> 
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Dicen que de la vida se disfruta según las gafas que se utilizan. Si se utilizan unas gafas de color rojo todo se ve muy brillante y si se usan las gafas grises todo se ve oscuro.
                                 En esta semana se utilizarán las gafas como metáfora de las emociones relacionando el color de las estas con las emociones. Reflexiona acerca de las gafas que te quieres poner hoy.
                               </p></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/gafas-de-las-emociones-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
