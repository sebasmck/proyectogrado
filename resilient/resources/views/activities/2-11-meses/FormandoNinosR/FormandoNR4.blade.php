...
<div class="col-lg-offset-2 col-md-8">
        <form class="form">
            ...
            <div class="card-actionbar">
                  ...
                  <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/FormandoNR5')}}"> <button type="button" class="btn btn-default ink-reaction btn-primary-dark">Siguiente</button></a>
                  </div>
            </div>
