...
@section('title')
Intro Actividad Qué Quieres Ser Cuando Seas Grande
@endsection
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title animated lightSpeedIn" style="font-family: 'Raleway', sans-serif; font-size: 40px;" >
                Actividad qué quieres ser cuando seas grande 
            </div>
        </div> 
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                A los niños les gusta pensar en sus preferencias para cuando sean grandes, pues el contexto social, 
                                les permite observar sus gustos en términos de profesiones, ocupaciones u otras formas trabajo de la etapa adulta. 
                                La familia también juega un papel muy importante allí, y estas elecciones son relevantes para ellos.
                                 Por lo tanto, lee el siguiente cuento y sigue la instrucción.
                                </p></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/QuieroSerGrande1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
