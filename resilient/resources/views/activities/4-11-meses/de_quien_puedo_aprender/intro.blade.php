                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Dentro de las pautas de crianza son muy importantes los modelos a seguir,
                                 para los niños la construcción de su mundo está basado en la constante observación que realizan hacia los adultos,
                                 cuidadores o padres, docentes y personas significativas de su alrededor. Por esta razón, es vital que el niño logre
                                 reconocer a sus modelos y además aprenda las buenas prácticas y buenos hábitos en pro de su desarrollo infantil.
                               </p>
                            </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/de-quien-puedo-aprender-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
