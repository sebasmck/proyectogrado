                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Se considera importante el control emocional en los niños para que se puedan desempeñar en los diferentes contextos, está compuesto  por la  identificación, reconocimiento y regulación emocional, que facilita el desarrollo de la inteligencia emocional en el ser humano.
                               </p></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/identificacion-control-emocional-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
