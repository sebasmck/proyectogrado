...
@section('title')
Intro Actividad Caritas Felices
@endsection
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Aporte educativo, aporte afectivo, cuidado y estimulación, promoción de la resiliencia </td>
                                    </tr>
                                    <tr>
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                Caritas felices, es una actividad pensada para que los padres o cuidadores apoyen a sus niños en la identificación
                                 de emociones tanto en personas externas como en sí mismos y para instruir a los cuidadores en estrategias 
                                para que los niños identifiquen que tan seguro es el entorno según las expresiones de las personas.
                                </p></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/CaritasFelices1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
