...
<div class="row">
    <div class="row">
    <div class="col-sm-12">
    <div class="animated bounceInRight" style="border-style: dashed; border-color:#F57F08;border-radius:12px;">
        <div style="padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px;">
    <label><h3>
    ¡Haz hecho un gran trabajo! Ahora, tu identificas el tipo de pensamiento de tu niño, las
    actividades que el realiza de acuerdo su desarrollo cognitivo y motor.
    </h3>
         </label>
      </div>
    </div>
