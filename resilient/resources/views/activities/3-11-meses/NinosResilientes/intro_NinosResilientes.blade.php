...
@section('title')
Intro Actividad Formando Niños Resilientes
@endsection
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Creencias sobre la crianza</td>
                                    </tr>
                                    <tr>
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                Niños resilientes es una actividad que aporta a los padres para que reflexionen sus creencias sobre la crianza,
                                 muchas veces como padres se cree que todo lo que se hace está bien, pero también es cierto que se pueden hacer un poco 
                                 mejor las cosas. Por ende es importante en la educación que se da a los hijos, enseñar a que desarrollen la resiliencia
                                  a través de conductas,del control de pensamientos y de actitudes que ellos pueden aprender con el ejemplo y 
                                  la orientación de los cuidadores.
                                </p></label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/NinosResilientes1')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
