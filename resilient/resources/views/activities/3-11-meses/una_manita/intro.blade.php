                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Una manita es una actividad que te va a facilitar como cuidador a identificar en el entorno
                                 en el cual se está desarrollando tu niño las personas que representan protección para él y
                                 apoyo para ti en la crianza y cuidado, adicionalmente te ofrece la oportunidad de educar en
                                 tu niño comportamientos asertivos, cómo buscar ayuda ante situaciones que lo ponga en riesgo.
                               </p>
                            </label>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/una-manita-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
