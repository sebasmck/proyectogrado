                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Aporte educativo, promoción de la resiliencia.</td>
                                    </tr>
                                    <tr>
                                        <td>Rasgos resilientes</td>
                                        <td>Vínculo afectivo, confianza.</td>
                                    </tr>
                                    <tr>
                                        <td>Semana</td>
                                        <td>3</td>
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionExample">
                            ...
                            <label> 
                               <p style="text-align:justify; text-justify: inter-word; color:black;">
                                 Papito escultor es una actividad pensada con el fin de que los cuidadores apoyen a sus niños a partir
                                 del moldeamiento del comportamiento el cual consiste en aumentar la frecuencia de una conducta
                                 en un individuo que no la realiza o que no la hace con tanta frecuencia como se desearía mediante
                                 el reforzamiento de  aproximaciones sucesivas a una conducta meta. Esta tarea es fundamental
                                 en la crianza de los niños y puede resultar un gran reto para los cuidadores,
                                 pero finalmente es gratificante pues los cuidadores consiguen que sus niños se comporten de la manera deseada.
                                 ¿Quieres aprender esta técnica?</p>
                            </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a style="btn btn-flat btn-primary ink-reaction" href="{{route('/papito-escultor-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
                </div><!--end .card-actionbar -->
            </div>
        </div>
