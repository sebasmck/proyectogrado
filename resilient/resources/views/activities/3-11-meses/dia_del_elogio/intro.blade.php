...
@section('title')
Intro Actividad Día del elogio
@endsection
                        ...
                        <table class="container">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Vínculo afectivo, confianza, independencia</td>
                                    </tr>
                                    <tr>
                                        <td>Semana</td>
                                        <td>2</td>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-actionbar">
                    ...
                    <a  href="{{route('/dia-del-elogio-2')}}"> <button type="button" style="margin-top:50px; margin-left:30%; margin-right:30% ">Comenzar</button></a>
                    </div>
